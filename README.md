...
Wildfire risk is increasing worldwide due to climate change, rising temperatures, and recurring drought. The Asir and Al-Soudah region in southern Saudi Arabia is one of the environmentally sensitive areas exposed to these risks.
...
Lack of systems that rely on local climate and geographic data for predicting fire ignition.
...
Weather variables and FWI components were added using the Open-Meteo API.
...
The highest performance was achieved by XGBoost with Oversampling, with an accuracy of 0.97.
